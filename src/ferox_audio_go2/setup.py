...
setup(
    ...
    entry_points={"console_scripts": [
        ...
        "go2_audio_aec3_offline_certificate = ferox_audio_go2.aec3_offline_certificate:main",
        ...
        "go2_audio_native_timing_certificate = ferox_audio_go2.native_timing_certificate:main",
